...
class NeuralNetwork {
   public:
	...
	void train(std::vector<std::tuple<xt::xarray<float>, xt::xarray<float>>> samples, float validationSplit, std::vector<std::tuple<xt::xarray<float>, xt::xarray<float>>> validSamples, int epochs, int patience);
